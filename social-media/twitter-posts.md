# ProjectAdulting - Twitter/X Post Templates
...
**Post 1 — App Intro**
Nobody taught us how to do taxes, build credit, or cook a real meal.
...
Adulting is hard when nobody gave you the manual.

ProjectAdulting IS the manual.
...
**Post 3 — Relatable Hook**
You can solve calculus but can't file your own taxes?

Same. That's why ProjectAdulting exists.

#Adulting #LearnOnTikTok #LifeHacks
...
Drop your answer below. ProjectAdulting has lessons for all of them.

---

**Post 5 — Question Thread**
What's one thing you wish someone had taught you before you turned 18?

We're building lessons around YOUR answers. Reply below.

#ProjectAdulting

---

**Post 6 — Quick Tip (Recurring Series)**
ProjectAdulting Tip #[number]:
...
**Post 9 — Tax Season**
Tax season is here and you're Googling "how to file taxes" again?
...
**Post 10 — Back to School / New Year**
New year, new adulting skills.
...
**Thread — "5 Things School Should Have Taught You"**

1/ School taught you the Pythagorean theorem but not how to:
...
A thread on what they missed (and how to learn it now):

2/ TAXES: You don't need an accountant for a simple return. Learn the basics — W-2s, deductions, filing status. ProjectAdulting breaks it down in plain English.

3/ CREDIT: Your credit score affects rent, loans, even jobs. Start building it early. We teach you how — no finance degree needed.

4/ COOKING: You don't need to be a chef. Learn 5 basic meals and you'll save hundreds a month. Our app has beginner-friendly recipes.

5/ BUDGETING: Track where your money goes. The 50/30/20 rule is a great start. ProjectAdulting has interactive lessons to build your plan.
